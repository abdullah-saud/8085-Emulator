...
public :
            ...
            void copy_data();
            void revert_back();
            string value_adjuster(string,int);
            string to_case(string,int);
            ...
            string hex_adder(string,string);
            string hex_subtracter(string,string);
            string* validate_register(char);
            string* validate_address(string);
            int mneuonics_validator(string);
            void SET(string);
            void MOV(string);
            void MVI(string);
            void LXI(string);
...
void micro :: initiator()
{
    ...
    A="00",B="00",C="00",D="00",E="00",H="00",L="00",M="0000",W="00",Z="00";
    SP="0050",PC="0050";
    ic=0,AddrSc=50;

    tA="00",tB="00",tC="00",tD="00",tE="00",tH="00",tL="00",tM="0000";
    tSP="0000",tPC="0000";
    tAddrSc=50;
}

void micro :: mneumonics()
{
   	mne[0]="SET";
	mne[1]="MOV";
	mne[2]="MVI";
...
string micro :: value_adjuster(string str,int n)
{
    string tstr;
    int l,i,j;
...
string micro :: to_case(string str,int mode)
{
    int l,i;
...
string micro :: bin_converter(string str)
{
    string res;
    int l,i;
...
string micro :: bin_reverter(string str)
{
    string tstr,st;
    int l,i;
...
void micro :: bin_adder(char ch1,char ch2,char *carry,char *res)
{
    int n1,n2,cry,sum,l;
...
string micro :: IIs_compliment(string str)
{
    string tstr;
    char carry,res;
    int l,i;
...
string micro :: hex_converter(int n)
{
	stringstream ss;
    ss<<hex<<n;
    string res(ss.str());
...
int micro :: dec_converter(string str)
{
    int res;
...
void micro :: hex_validator(string str,int mode)
{
    int l,i;
...
string micro :: hex_adder(string str1,string str2)
{
...
string micro :: hex_subtracter(string str1,string str2)
{
...
string* micro :: validate_register(char ch)
{
    int tM;
...
string* micro :: validate_address(string str)
{
    int temp,l;
...
int micro :: mneuonics_validator(string st)
{
    int flag,i;
...
void micro :: executer(string str)
{
    string tstr,ttstr;
        ...
        if(l==1)
        {
            if(str[0]=='r')
            {
                ...
                if(AddrSc<=65534)
                {
                    ...
                    {
                        getline(fin,tstr);
                        instr[AddrSc]=to_case(tstr,1);

                        tstr=hex_converter(AddrSc);
                        tstr=to_case(tstr,1);
                        SP=value_adjuster(tstr,4);

                        if((AddrSc==655532) || (AddrSc==655533) || (AddrSc==655534))
                        {
                            copy_data();
                        }
